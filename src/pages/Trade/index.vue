  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="detail">
        ...
        <ul
          class="list clearFix"
          v-for="(shop, index) in shopInfo.detailArrayList"
          :key="shop.skuId"
        >
          <li>
            <img
...
export default {
  ...
  methods: {
    ...
    async submitOrder() {
      ...
      //需要带参数（tradeNo,data）
      let { tradeNo } = this.shopInfo; //将shopInfo中的tradeNo(交易编码)结构出来
      //其余的六个参数
      let data = {
        consignee: this.userDefaultAddress.consignee, //最终收件人的名字
        consigneeTel: this.userDefaultAddress.phoneNum, //最终收件人的手机号
        deliveryAddress: this.userDefaultAddress.fullAddress, //最终地址
        paymentWay: "ONLINE", //支付方式
        orderComment: this.msg, //买家留言信息
        orderDetailList: this.shopInfo.detailArrayList, //购物车商品清单
      };
